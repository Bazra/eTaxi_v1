...
public class BookingUpdateRequest extends StringRequest {
    ...
    public BookingUpdateRequest(String roadType, String driverEmail, String passengerEmail, String srcLat,
                          String srcLong, String destLat, String destLong, /*String bookingStatus*/
                          String amount, Response.Listener<String>listener) {
        super(Method.PUT, BOOKING_REQUEST_URL, listener, null);
